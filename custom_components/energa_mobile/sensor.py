"""Sensors for Energa Mobile v2.7.3."""
...
class EnergaSensor(CoordinatorEntity, SensorEntity):
    ...
    def device_info(self) -> DeviceInfo:
        ...
        return DeviceInfo(identifiers={(DOMAIN, self.coordinator.config_entry.entry_id)}, name=f"Licznik Energa {data.get('meter_point_id')}", manufacturer="Energa-Operator", model=f"PPE: {data.get('ppe')}", configuration_url="https://mojlicznik.energa-operator.pl", sw_version="2.7.1")